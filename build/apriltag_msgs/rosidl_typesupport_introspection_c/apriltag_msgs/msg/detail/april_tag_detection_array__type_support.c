...
void apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__AprilTagDetectionArray_fini_function(
    void *message_memory)
{
    ...
    const void *untyped_member, size_t index, void *untyped_value)
{
    const apriltag_msgs__msg__AprilTagDetection *item =
        ((const apriltag_msgs__msg__AprilTagDetection *)
             apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__get_const_function__AprilTagDetectionArray__detections(
                 untyped_member, index));
    apriltag_msgs__msg__AprilTagDetection *value = (apriltag_msgs__msg__AprilTagDetection *)(untyped_value);
    *value = *item;
}
    ...
    void *untyped_member, size_t index, const void *untyped_value)
{
    apriltag_msgs__msg__AprilTagDetection *item =
        ((apriltag_msgs__msg__AprilTagDetection *)
             apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__get_function__AprilTagDetectionArray__detections(
                 untyped_member, index));
    const apriltag_msgs__msg__AprilTagDetection *value = (const apriltag_msgs__msg__AprilTagDetection *)(untyped_value);
    *item = *value;
}
...
static rosidl_typesupport_introspection_c__MessageMember
    apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__AprilTagDetectionArray_message_member_array[2] = {
        {
            "header",                                                      // name
...
static rosidl_message_type_support_t
    apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__AprilTagDetectionArray_message_type_support_handle = {
        0,
        &apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__AprilTagDetectionArray_message_members,
...
ROSIDL_TYPESUPPORT_INTROSPECTION_C_EXPORT_apriltag_msgs const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_msgs, msg,
                                                  AprilTagDetectionArray)()
{
    apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__AprilTagDetectionArray_message_member_array[0]
        .members_ =
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, std_msgs, msg, Header)();
    apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__AprilTagDetectionArray_message_member_array[1]
        .members_ = ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_msgs,
                                                                      msg, AprilTagDetection)();
    if (!apriltag_msgs__msg__AprilTagDetectionArray__rosidl_typesupport_introspection_c__AprilTagDetectionArray_message_type_support_handle
