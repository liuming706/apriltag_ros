...
{
    const apriltag_msgs__msg__Point *member = (const apriltag_msgs__msg__Point *)(untyped_member);
    return &member[index];
}
...
{
    apriltag_msgs__msg__Point *member = (apriltag_msgs__msg__Point *)(untyped_member);
    return &member[index];
}
    ...
    const void *untyped_member, size_t index, void *untyped_value)
{
    const apriltag_msgs__msg__Point *item =
        ((const apriltag_msgs__msg__Point *)
             apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__get_const_function__AprilTagDetection__corners(
                 untyped_member, index));
    apriltag_msgs__msg__Point *value = (apriltag_msgs__msg__Point *)(untyped_value);
    *value = *item;
}
    ...
    void *untyped_member, size_t index, const void *untyped_value)
{
    apriltag_msgs__msg__Point *item =
        ((apriltag_msgs__msg__Point *)
             apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__get_function__AprilTagDetection__corners(
                 untyped_member, index));
    const apriltag_msgs__msg__Point *value = (const apriltag_msgs__msg__Point *)(untyped_value);
    *item = *value;
}
...
{
    const double *item =
        ((const double *)apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__get_const_function__AprilTagDetection__homography(
            untyped_member, index));
...
{
    double *item =
        ((double *)apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__get_function__AprilTagDetection__homography(
            untyped_member, index));
...
static rosidl_typesupport_introspection_c__MessageMember
    apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__AprilTagDetection_message_member_array[8] = {
        {
            "family",                                                 // name
...
static rosidl_message_type_support_t
    apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__AprilTagDetection_message_type_support_handle = {
        0,
        &apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__AprilTagDetection_message_members,
                                                  ...
                                                  AprilTagDetection)()
{
    ...
    apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__AprilTagDetection_message_member_array[6].members_ =
        ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, apriltag_msgs, msg, Point)();
    if (!apriltag_msgs__msg__AprilTagDetection__rosidl_typesupport_introspection_c__AprilTagDetection_message_type_support_handle
