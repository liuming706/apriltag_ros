...
void AprilTagDetection_init_function(void *message_memory, rosidl_runtime_cpp::MessageInitialization _init)
{
...
{
    const auto &member = *reinterpret_cast<const std::array<apriltag_msgs::msg::Point, 4> *>(untyped_member);
    return &member[index];
}

void *get_function__AprilTagDetection__corners(void *untyped_member, size_t index)
{
    auto &member = *reinterpret_cast<std::array<apriltag_msgs::msg::Point, 4> *>(untyped_member);
    return &member[index];
}

void fetch_function__AprilTagDetection__corners(const void *untyped_member, size_t index, void *untyped_value)
{
...
void assign_function__AprilTagDetection__corners(void *untyped_member, size_t index, const void *untyped_value)
{
    auto &item =
        *reinterpret_cast<apriltag_msgs::msg::Point *>(get_function__AprilTagDetection__corners(untyped_member, index));
...
void fetch_function__AprilTagDetection__homography(const void *untyped_member, size_t index, void *untyped_value)
{
    const auto &item =
        *reinterpret_cast<const double *>(get_const_function__AprilTagDetection__homography(untyped_member, index));
    auto &value = *reinterpret_cast<double *>(untyped_value);
    value = item;
}

void assign_function__AprilTagDetection__homography(void *untyped_member, size_t index, const void *untyped_value)
{
    auto &item = *reinterpret_cast<double *>(get_function__AprilTagDetection__homography(untyped_member, index));
