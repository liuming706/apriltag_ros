...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    apriltag_msgs__msg__AprilTagDetection__REFERENCED_TYPE_DESCRIPTIONS[] = {
        {
            {apriltag_msgs__msg__Point__TYPE_NAME, 23, 23},
            {NULL, 0, 0},
        },
...
const rosidl_runtime_c__type_description__TypeDescription *apriltag_msgs__msg__AprilTagDetection__get_type_description(
    const rosidl_message_type_support_t *type_support)
{
    (void)type_support;
...
const rosidl_runtime_c__type_description__TypeSource *apriltag_msgs__msg__AprilTagDetection__get_individual_type_description_source(
    const rosidl_message_type_support_t *type_support)
{
    (void)type_support;
