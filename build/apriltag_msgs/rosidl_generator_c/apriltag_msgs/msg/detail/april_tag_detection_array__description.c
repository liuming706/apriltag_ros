    ...
    const rosidl_message_type_support_t *type_support)
{
    ...
    static rosidl_type_hash_t hash = {
        1,
        {
            0x60, 0x16, 0xbf, 0xe5, 0x13, 0xa7, 0xc7, 0x41, 0xcc, 0xbd, 0xbc, 0x64, 0x19, 0xed, 0x6c, 0x4c,
            0xab, 0xfe, 0x5f, 0x11, 0x27, 0x1a, 0x96, 0x55, 0x5f, 0xbf, 0x26, 0x56, 0x5c, 0x6b, 0x98, 0x26,
        }};
    return &hash;
}
...
#ifndef NDEBUG
static const rosidl_type_hash_t apriltag_msgs__msg__AprilTagDetection__EXPECTED_HASH = {
    1,
    {
        0x77, 0xc6, 0xbb, 0x37, 0xe0, 0xa9, 0xfe, 0x5f, 0x15, 0x96, 0x66, 0xb1, 0x4f, 0x33, 0x40, 0xf9,
        0x89, 0x74, 0x9d, 0x43, 0x6a, 0x2e, 0xe0, 0x1b, 0x5c, 0x53, 0xbd, 0xd7, 0xd7, 0x08, 0x5d, 0xbb,
    }};
static const rosidl_type_hash_t apriltag_msgs__msg__Point__EXPECTED_HASH = {
    1,
    {
        0xc4, 0x28, 0x99, 0x76, 0x7c, 0xe6, 0x20, 0xe6, 0xbe, 0xb2, 0x6a, 0xfe, 0xaf, 0x1e, 0xc6, 0x58,
        0xe6, 0xe3, 0xdb, 0xfd, 0x51, 0x20, 0x36, 0x83, 0x30, 0x56, 0x63, 0x23, 0xdd, 0xdf, 0x62, 0xf4,
    }};
static const rosidl_type_hash_t builtin_interfaces__msg__Time__EXPECTED_HASH = {
    1,
    {
...
static const rosidl_type_hash_t std_msgs__msg__Header__EXPECTED_HASH = {
    1,
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription
    apriltag_msgs__msg__AprilTagDetectionArray__REFERENCED_TYPE_DESCRIPTIONS[] = {
        {
            {apriltag_msgs__msg__AprilTagDetection__TYPE_NAME, 35, 35},
            {NULL, 0, 0},
        },
...
const rosidl_runtime_c__type_description__TypeDescription *apriltag_msgs__msg__AprilTagDetectionArray__get_type_description(
    const rosidl_message_type_support_t *type_support)
{
    (void)type_support;
    ...
    if (!constructed) {
        assert(0 == memcmp(&apriltag_msgs__msg__AprilTagDetection__EXPECTED_HASH,
                           apriltag_msgs__msg__AprilTagDetection__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
        description.referenced_type_descriptions.data[0].fields =
            apriltag_msgs__msg__AprilTagDetection__get_type_description(NULL)->type_description.fields;
        assert(0 == memcmp(&apriltag_msgs__msg__Point__EXPECTED_HASH, apriltag_msgs__msg__Point__get_type_hash(NULL),
                           sizeof(rosidl_type_hash_t)));
        description.referenced_type_descriptions.data[1].fields =
            apriltag_msgs__msg__Point__get_type_description(NULL)->type_description.fields;
        assert(0 == memcmp(&builtin_interfaces__msg__Time__EXPECTED_HASH,
                           builtin_interfaces__msg__Time__get_type_hash(NULL), sizeof(rosidl_type_hash_t)));
        description.referenced_type_descriptions.data[2].fields =
            builtin_interfaces__msg__Time__get_type_description(NULL)->type_description.fields;
        assert(0 == memcmp(&std_msgs__msg__Header__EXPECTED_HASH, std_msgs__msg__Header__get_type_hash(NULL),
                           sizeof(rosidl_type_hash_t)));
        description.referenced_type_descriptions.data[3].fields =
            std_msgs__msg__Header__get_type_description(NULL)->type_description.fields;
        constructed = true;
    }
    return &description;
}
...
const rosidl_runtime_c__type_description__TypeSource *apriltag_msgs__msg__AprilTagDetectionArray__get_individual_type_description_source(
    const rosidl_message_type_support_t *type_support)
{
    (void)type_support;
