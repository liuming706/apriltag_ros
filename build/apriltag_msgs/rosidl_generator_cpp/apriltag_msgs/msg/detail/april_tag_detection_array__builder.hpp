...
{
public:
    explicit Init_AprilTagDetectionArray_detections(::apriltag_msgs::msg::AprilTagDetectionArray &msg) : msg_(msg) {}
...
{
public:
    Init_AprilTagDetectionArray_header() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP) {}
...
template <>
inline auto build<::apriltag_msgs::msg::AprilTagDetectionArray>()
{
