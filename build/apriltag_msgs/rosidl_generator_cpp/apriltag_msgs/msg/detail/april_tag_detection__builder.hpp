...
{
public:
    explicit Init_AprilTagDetection_homography(::apriltag_msgs::msg::AprilTagDetection &msg) : msg_(msg) {}
...
{
public:
    explicit Init_AprilTagDetection_corners(::apriltag_msgs::msg::AprilTagDetection &msg) : msg_(msg) {}
...
{
public:
    explicit Init_AprilTagDetection_centre(::apriltag_msgs::msg::AprilTagDetection &msg) : msg_(msg) {}
...
{
public:
    explicit Init_AprilTagDetection_decision_margin(::apriltag_msgs::msg::AprilTagDetection &msg) : msg_(msg) {}
...
{
public:
    explicit Init_AprilTagDetection_goodness(::apriltag_msgs::msg::AprilTagDetection &msg) : msg_(msg) {}
...
{
public:
    explicit Init_AprilTagDetection_hamming(::apriltag_msgs::msg::AprilTagDetection &msg) : msg_(msg) {}
...
{
public:
    explicit Init_AprilTagDetection_id(::apriltag_msgs::msg::AprilTagDetection &msg) : msg_(msg) {}
...
{
public:
    Init_AprilTagDetection_family() : msg_(::rosidl_runtime_cpp::MessageInitialization::SKIP) {}
...
template <>
inline auto build<::apriltag_msgs::msg::AprilTagDetection>()
{
