...
inline void to_flow_style_yaml(const AprilTagDetectionArray &msg, std::ostream &out)
{
    out << "{";
    // member: header
    {
...
inline void to_block_style_yaml(const AprilTagDetectionArray &msg, std::ostream &out, size_t indentation = 0)
{
    // member: header
    {
        if (indentation > 0) {
...
[[deprecated("use apriltag_msgs::msg::to_block_style_yaml() instead")]] inline void to_yaml(
    const apriltag_msgs::msg::AprilTagDetectionArray &msg, std::ostream &out, size_t indentation = 0)
{
    apriltag_msgs::msg::to_block_style_yaml(msg, out, indentation);
}

[[deprecated("use apriltag_msgs::msg::to_yaml() instead")]] inline std::string to_yaml(
...
template <>
struct has_fixed_size<apriltag_msgs::msg::AprilTagDetectionArray> : std::integral_constant<bool, false> {
};

template <>
struct has_bounded_size<apriltag_msgs::msg::AprilTagDetectionArray> : std::integral_constant<bool, false> {
};

template <>
struct is_message<apriltag_msgs::msg::AprilTagDetectionArray> : std::true_type {
};
