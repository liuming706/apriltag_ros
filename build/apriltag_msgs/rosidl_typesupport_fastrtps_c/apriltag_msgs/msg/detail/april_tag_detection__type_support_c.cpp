...
bool cdr_serialize_apriltag_msgs__msg__Point(const apriltag_msgs__msg__Point *ros_message, eprosima::fastcdr::Cdr &cdr);

bool cdr_deserialize_apriltag_msgs__msg__Point(eprosima::fastcdr::Cdr &cdr, apriltag_msgs__msg__Point *ros_message);

size_t get_serialized_size_apriltag_msgs__msg__Point(const void *untyped_ros_message, size_t current_alignment);

size_t max_serialized_size_apriltag_msgs__msg__Point(bool &full_bounded, bool &is_plain, size_t current_alignment);

bool cdr_serialize_key_apriltag_msgs__msg__Point(const apriltag_msgs__msg__Point *ros_message, eprosima::fastcdr::Cdr &cdr);

size_t get_serialized_size_key_apriltag_msgs__msg__Point(const void *untyped_ros_message, size_t current_alignment);

size_t max_serialized_size_key_apriltag_msgs__msg__Point(bool &full_bounded, bool &is_plain, size_t current_alignment);
    ...
    const apriltag_msgs__msg__AprilTagDetection *ros_message, eprosima::fastcdr::Cdr &cdr)
{
    ...
    // Field name: centre
    {
        cdr_serialize_apriltag_msgs__msg__Point(&ros_message->centre, cdr);
    }
    ...
    // Field name: corners
    {
        ...
        for (size_t i = 0; i < size; ++i) {
            cdr_serialize_apriltag_msgs__msg__Point(&array_ptr[i], cdr);
        }
    }
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_apriltag_msgs bool cdr_deserialize_apriltag_msgs__msg__AprilTagDetection(
    eprosima::fastcdr::Cdr &cdr, apriltag_msgs__msg__AprilTagDetection *ros_message)
{
    // Field name: family
    {
        std::string tmp;
        ...
        bool succeeded = rosidl_runtime_c__String__assign(&ros_message->family, tmp.c_str());
        if (!succeeded) {
...
{
    const _AprilTagDetection__ros_msg_type *ros_message =
        static_cast<const _AprilTagDetection__ros_msg_type *>(untyped_ros_message);
    (void)ros_message;
    ...
    // Field name: centre
    current_alignment += get_serialized_size_apriltag_msgs__msg__Point(&(ros_message->centre), current_alignment);
    ...
    // Field name: corners
    {
        ...
        for (size_t index = 0; index < array_size; ++index) {
            current_alignment += get_serialized_size_apriltag_msgs__msg__Point(&array_ptr[index], current_alignment);
        }
    }
...
max_serialized_size_apriltag_msgs__msg__AprilTagDetection(bool &full_bounded, bool &is_plain, size_t current_alignment)
{
    ...
    // Field name: centre
    {
        ...
        for (size_t index = 0; index < array_size; ++index) {
            ...
            size_t inner_size;
            inner_size =
                max_serialized_size_apriltag_msgs__msg__Point(inner_full_bounded, inner_is_plain, current_alignment);
    ...
    const apriltag_msgs__msg__AprilTagDetection *ros_message, eprosima::fastcdr::Cdr &cdr)
{
    ...
    // Field name: centre
    {
        cdr_serialize_key_apriltag_msgs__msg__Point(&ros_message->centre, cdr);
    }
    ...
    // Field name: corners
    {
        ...
        auto array_ptr = ros_message->corners;
        for (size_t i = 0; i < size; ++i) {
            cdr_serialize_key_apriltag_msgs__msg__Point(&array_ptr[i], cdr);
        }
    }
...
get_serialized_size_key_apriltag_msgs__msg__AprilTagDetection(const void *untyped_ros_message, size_t current_alignment)
{
    ...
    // Field name: centre
    current_alignment += get_serialized_size_key_apriltag_msgs__msg__Point(&(ros_message->centre), current_alignment);
    ...
    // Field name: corners
    {
        ...
        auto array_ptr = ros_message->corners;
        for (size_t index = 0; index < array_size; ++index) {
            current_alignment += get_serialized_size_key_apriltag_msgs__msg__Point(&array_ptr[index], current_alignment);
        }
    }
    ...
    bool &full_bounded, bool &is_plain, size_t current_alignment)
{
    ...
    // Field name: centre
    {
        ...
        for (size_t index = 0; index < array_size; ++index) {
            ...
            size_t inner_size;
            inner_size =
                max_serialized_size_key_apriltag_msgs__msg__Point(inner_full_bounded, inner_is_plain, current_alignment);
            last_member_size += inner_size;
            current_alignment += inner_size;
            full_bounded &= inner_full_bounded;
            is_plain &= inner_is_plain;
...
static bool _AprilTagDetection__cdr_serialize(const void *untyped_ros_message, eprosima::fastcdr::Cdr &cdr)
{
    ...
    const apriltag_msgs__msg__AprilTagDetection *ros_message =
        static_cast<const apriltag_msgs__msg__AprilTagDetection *>(untyped_ros_message);
    (void)ros_message;
...
static bool _AprilTagDetection__cdr_deserialize(eprosima::fastcdr::Cdr &cdr, void *untyped_ros_message)
{
    ...
    apriltag_msgs__msg__AprilTagDetection *ros_message =
        static_cast<apriltag_msgs__msg__AprilTagDetection *>(untyped_ros_message);
    (void)ros_message;
...
{
    return static_cast<uint32_t>(get_serialized_size_apriltag_msgs__msg__AprilTagDetection(untyped_ros_message, 0));
}
...
static size_t _AprilTagDetection__max_serialized_size(char &bounds_info)
{
    ...
    ret_val = max_serialized_size_apriltag_msgs__msg__AprilTagDetection(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t __callbacks_AprilTagDetection = {"apriltag_msgs::msg",
                                                                         "AprilTagDetection",
