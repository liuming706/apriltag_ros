...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_msgs
cdr_deserialize(eprosima::fastcdr::Cdr &cdr, apriltag_msgs::msg::AprilTagDetectionArray &ros_message);
...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_msgs
cdr_serialize_key(const apriltag_msgs::msg::AprilTagDetectionArray &ros_message, eprosima::fastcdr::Cdr &);
