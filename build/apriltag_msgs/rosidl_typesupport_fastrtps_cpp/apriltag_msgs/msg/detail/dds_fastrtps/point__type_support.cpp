...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_msgs cdr_serialize(const apriltag_msgs::msg::Point &ros_message,
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_msgs get_serialized_size(const apriltag_msgs::msg::Point &ros_message,
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_msgs max_serialized_size_Point(bool &full_bounded, bool &is_plain,
                                                                                      size_t current_alignment)
{
    size_t initial_alignment = current_alignment;
...
bool ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_msgs cdr_serialize_key(const apriltag_msgs::msg::Point &ros_message,
                                                                            eprosima::fastcdr::Cdr &cdr)
{
    // Member: x
    cdr << ros_message.x;
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_msgs get_serialized_size_key(const apriltag_msgs::msg::Point &ros_message,
                                                                                    size_t current_alignment)
{
    size_t initial_alignment = current_alignment;
...
size_t ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_apriltag_msgs max_serialized_size_key_Point(bool &full_bounded, bool &is_plain,
                                                                                          size_t current_alignment)
{
    size_t initial_alignment = current_alignment;
...
{
    auto typed_message = static_cast<const apriltag_msgs::msg::Point *>(untyped_ros_message);
    return cdr_serialize(*typed_message, cdr);
}

static bool _Point__cdr_deserialize(eprosima::fastcdr::Cdr &cdr, void *untyped_ros_message)
{
    auto typed_message = static_cast<apriltag_msgs::msg::Point *>(untyped_ros_message);
